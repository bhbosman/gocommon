...
func (self *connectionReactorFactory) Create(name string, cancelCtx context.Context, cancelFunc context.CancelFunc, logger fx.ILogger, userContext interface{}) commsImpl.IConnectionReactor {
